...
<html>
        ...
        <form action="${createLink(controller: 'report', action: 'generateReceita')}" method="GET">
        ...
        <table class="styled-table">
            ...
            <g:each in="${payments}" var="payment">
                <tr>
                    <td>${payment.reserva.referencia}</td>
                    <td>${payment.reserva.hospede.nomeHospede}</td>
                    <td>${payment.reserva.quartos.size()}</td>
                    <td>${payment.valorPagarTotal ?: 'Não Pago'}</td>
                </tr>
            </g:each>
            </tbody>
        </table>
