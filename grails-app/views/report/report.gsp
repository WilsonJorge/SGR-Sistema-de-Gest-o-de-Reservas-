...
<html>
        ...
        <form action="${createLink(controller: 'report', action: 'generate')}" method="GET">
            <div class="filter-container">
                ...
                <label for="roomTypeId">Tipo  de Quarto:</label>
                <select name="roomTypeId" id="quartoTipo">
                    <option value="">Todos</option> <!-- Opção "Todos" -->
                    <g:each in="${projecto.intellica.hotel.QuartoTipo.list()}" var="quartoTipo">
                        <option value="${quartoTipo.id}" ${params.roomTypeId == quartoTipo.id ? 'selected' : ''}>${quartoTipo.tipoQuarto}</option>
                    </g:each>
                </select>
            </div>
                    <div class="willy">
        ...
        <table class="styled-table">
            ...
            <g:each in="${reservations}" var="reservation">
                <tr>
                    <td>${reservation?.referencia}</td>
                    <td>${reservation?.hospede?.nomeHospede}</td>
                    <td>${reservation?.estado}</td>
                    <td>${reservation?.quartos.size()}</td>
                    <td>${reservation?.numeroCrianca}</td>
                    <td>${reservation?.numeroAdultos}</td>
                </tr>
            </g:each>
            </tbody>
        </table>
