            ...
            <table class="sm-w-full" width="500" cellpadding="0" cellspacing="0" role="presentation">
                <td align="left" class="sm-p-20 sm-dui17-b-t" style="border-radius: 2px; padding: 40px; position: relative; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, .1), 0 4px 6px -2px rgba(0, 0, 0, .05); vertical-align: top; z-index: 50;" bgcolor="#ffffff" valign="top">
                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                        <tr>
                            <td style="text-align: left;" width="20%" align="left">
                                ...
                                %{--</svg>--}%
                                    <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M21 11H6.414l5.293-5.293-1.414-1.414L2.586 12l7.707 7.707 1.414-1.414L6.414 13H21z"></path></svg>
                                </g:link>
                            </td>
                            <td width="60%">
                                <h1 class="sm-text-lg all-font-roboto" style="font-weight: 700; line-height: 100%; margin: 0; margin-bottom: 4px; font-size: 24px;">Pagamento via Banco</h1>
                                <p class="sm-text-xs" style="margin: 0; color: #718096; font-size: 14px;">AV:Nelson Mandela</p>
                                <p class="sm-text-xs" style="margin: 0; color: #718096; font-size: 14px;">REST-AND-PEACE</p>
                            </td>
                            <td style="text-align: right;" width="20%" align="right">
                                <a href="#" target="_blank" onclick="imprimirRecibo()" style="text-decoration: none;">
                    ...
                    <table class="sm-leading-32" style="line-height: 28px; font-size: 14px;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                        ...
                        <!-- Destinatario -->
                        <tr>
                            <td class="sm-w-full sm-inline-block" style="font-weight: 600;" width="100%">Destinatário</td>
                        </tr>
                        <tr>
                            <td class="sm-w-full sm-inline-block" style="text-align: left;" width="100%"><p style="margin-top: -1px;margin-bottom: -1px;">${nomeHospede}</p></td>
                        </tr>

                        <tr>
                            <td class="sm-w-full sm-inline-block" style="text-align: left;" width="100%"><p style="margin-top: -1px;">Numero de Criancas: ${numeroCriancas}</p></td>
                        </tr>
                        <tr>
                            <td class="sm-w-full sm-inline-block" style="text-align: left;" width="100%"><p style="margin-top: -1px;">Numero de Adultos: ${numeroAdultos}</p></td>
                        </tr>
                        <!-- FIM Destinatario -->
                        <!-- Origem -->
                        <tr>
                            <td class="sm-w-full sm-inline-block" style="font-weight: 600;" width="100%">Reserva</td>
                        </tr>
                        <tr>
                            <td class="sm-w-full sm-inline-block" style="text-align: left;" width="100%"><p style="margin-top: -1px;margin-bottom: -1px;">Hotel Rest-And-Peace</p></td>
                        </tr>
                        <tr>
                            <td class="sm-w-full sm-inline-block" style="text-align: left;" width="100%"><p style="margin-bottom: -1px;margin-top: -1px;">Data Entrada: ${dataFormatada1}</p></td>
                        </tr>
                        <tr>
                            <td class="sm-w-full sm-inline-block" style="text-align: left;" width="100%"><p style="margin-top: -1px;">Data Saida: ${dataFormatada2}</p></td>
                        </tr>
                        <!-- FIM Origem -->
                        <tr>
                            <td style="padding-top: 12px; padding-bottom: 12px;">
                        ...
                        <!-- ID PIX -->
                        <tr>
                            <td class="sm-w-full sm-inline-block" style="font-weight: 600;" width="100%">Provincia</td>
                        </tr>
                        <tr>
                            <td class="sm-w-full sm-inline-block" style="text-align: left;" width="100%"><p style="margin-top: -1px;margin-bottom: -1px;">Maputo,Ponta de Ouro</p></td>
                        </tr>
                        <!-- FIM ID PIX -->
                    </table>
                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    ...
                    <table style="line-height: 28px; font-size: 14px;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                        <tr>
                            <td style="color: #718096;" width="50%">Pagamento</td>
                            <td style="font-weight: 600; text-align: right;" width="50%" align="right">Saldo</td>
                        </tr>
                        <tr>
                            <td style="color: #718096;" width="50%">Total pago</td>
                            <td style="font-weight: 600; text-align: right;" width="50%" align="right">Mt ${valorPagarTotal}</td>
                        </tr>
                        <tr>
                            <td style="font-weight: 600; padding-top: 32px; color: #000000; font-size: 20px;" width="50%">Valor</td>
                            <td style="font-weight: 600; padding-top: 32px; text-align: right;font-size: 20px;" width="50%" align="right">Mt ${valorPagarTotal}</td>
                        </tr>
                    </table>
...
<script>
    function imprimirRecibo() {
        ...
        var conteudoRecibo = document.documentElement.outerHTML;

        // Abre uma nova janela para imprimir
        var janelaImprimir = window.open('', '_blank', 'width=800,height=600');

        // Escreve o conteúdo do recibo na nova janela
        janelaImprimir.document.open();
        janelaImprimir.document.write(conteudoRecibo);
        janelaImprimir.document.close();

        // Espera o carregamento da janela e inicia a impressão
